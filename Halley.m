% SOLUTION TO ECE6390 Homework #1
% Halley’s Comet (part (d))
clear all
close all
% Physical Constants
G = 6.672e-11; % Gravitational Constant (Newton meters^2 kilograms^-2)
Mp = 1.98e30; % Mass of the Sun (kilograms)
MAX_ITERATION = 3e4; % Largest number of iterations
AU = 150e9; % astronomical unit (meters)
% Initial Conditions
dt = 100000; % increment (seconds)
r = 0.586*AU; % initial radius (meters)
theta = 0; % initial angle (radians)
V_r = 0; % r-component of velocity (meters/second)
V_theta = 54.4e3; % theta-component of velocity (meters/second)
